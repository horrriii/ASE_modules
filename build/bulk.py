...
def bulk(name, crystalstructure=None, a=None, b=None, c=None, *, alpha=None,
    ...
    structures = {'sc': 1, 'fcc': 1, 'bcc': 1,
                  ...
                  'fluorite': 3, 'wurtzite': 2, 'pyrite': 3}
    ...
    if orthorhombic and crystalstructure not in ['sc', 'tetragonal',
        ...
        dimer4=Atoms([symbol3, symbol2],scaled_positions=[(0.5-u, u, 1-u),(0.5+u, 1-u, u)],cell=(a, a, a), pbc=True)
        atoms = atoms+dimer1+dimer2+dimer3+dimer4
